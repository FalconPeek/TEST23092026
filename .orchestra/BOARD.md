...
| T-023 | M5 strings, badges on profile, share button, templates from es.ts | M5 | in_progress | deps T-020; /api/og/card ready |
...
| T-033 | polish: tournament stepper labels, format card highlight | M4 | todo | deps T-032 |
